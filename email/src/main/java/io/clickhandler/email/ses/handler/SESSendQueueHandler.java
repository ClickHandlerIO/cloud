package io.clickhandler.email.ses.handler;
...
import io.clickhandler.cloud.model.EmailAttachmentEntity;
...
import io.clickhandler.email.ses.event.SESEmailSentEvent;
    ...
    private class FileChunksIterator implements FileGetChunksHandler {
        ...
        public void onComplete() {
            try {
                ...
                final DataSource ds = new ByteArrayDataSource(buffer.toString(), currentAttachment.getMimeType());
