package io.clickhandler.email.sns.routing.common;
...
public abstract class SNSRouteHandler<T extends Message> implements Handler<RoutingContext> {
    ...
    // SNS Header Keys
    protected static final String TYPE_HEADER = "x-amz-io.clickhandler.email.sns-message-type";
    protected static final String MESSAGE_ID_HEADER = "x-amz-io.clickhandler.email.sns-message-id";
    protected static final String TOPIC_ARN_HEADER = "x-amz-io.clickhandler.email.sns-topic-arn";
    protected static final String SUBSCRIPTION_ARN_HEADER = "x-amz-io.clickhandler.email.sns-subscription-arn";
