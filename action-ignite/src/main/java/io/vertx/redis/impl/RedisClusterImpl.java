...
public class RedisClusterImpl extends AbstractRedisClusterClient {
  ...
  @Override
  public RedisCluster brpoplpush(String key, String destkey, int seconds,
      Handler<AsyncResult<String>> handler) {
    sendString(BRPOPLPUSH, toPayload(key, destkey, seconds), RedisClusterCRC16.getSlot(key),
        handler);
    return this;
  }
  ...
  @Override
  public RedisCluster getrange(String key, long start, long end,
      Handler<AsyncResult<String>> handler) {
  ...
  @Override
  public RedisCluster hincrby(String key, String field, long increment,
  ...
  @Override
  public RedisCluster hincrbyfloat(String key, String field, double increment,
      Handler<AsyncResult<String>> handler) {
    sendString(HINCRBYFLOAT, toPayload(key, field, increment), RedisClusterCRC16.getSlot(key),
        handler);
    return this;
  }
  ...
  @Override
  public RedisCluster hmget(String key, List<String> fields,
  ...
  @Override
  public RedisCluster hset(String key, String field, String value,
      Handler<AsyncResult<Long>> handler) {
  ...
  @Override
  public RedisCluster hsetnx(String key, String field, String value,
      Handler<AsyncResult<Long>> handler) {
  ...
  @Override
  public RedisCluster incrbyfloat(String key, double increment,
      Handler<AsyncResult<String>> handler) {
  ...
  public RedisCluster linsert(String key, InsertOptions option, String pivot, String value,
      Handler<AsyncResult<Long>> handler) {
    sendLong(LINSERT, toPayload(key, option.name(), pivot, value), RedisClusterCRC16.getSlot(key),
        handler);
    return this;
  }
  ...
  @Override
  public RedisCluster lpushMany(String key, List<String> values,
      Handler<AsyncResult<Long>> handler) {
  ...
  @Override
  public RedisCluster lrange(String key, long from, long to,
      Handler<AsyncResult<JsonArray>> handler) {
  ...
  @Override
  public RedisCluster lrem(String key, long count, String value,
      Handler<AsyncResult<Long>> handler) {
  ...
  @Override
  public RedisCluster lset(String key, long index, String value,
      Handler<AsyncResult<String>> handler) {
  ...
  @Override
  public RedisCluster rpushMany(String key, List<String> values,
      Handler<AsyncResult<Long>> handler) {
  ...
  @Override
  public RedisCluster saddMany(String key, List<String> members,
      Handler<AsyncResult<Long>> handler) {
  ...
  public RedisCluster setWithOptions(String key, String value, SetOptions options,
      Handler<AsyncResult<String>> handler) {
    sendString(SET, toPayload(key, value, options != null ? options.toJsonArray() : null),
        RedisClusterCRC16.getSlot(key), handler);
    return this;
  }

  @Override
  public RedisCluster setex(String key, long seconds, String value,
      Handler<AsyncResult<String>> handler) {
  ...
  @Override
  public RedisCluster setrange(String key, int offset, String value,
      Handler<AsyncResult<Long>> handler) {
  ...
  @Override
  public RedisCluster sremMany(String key, List<String> members,
      Handler<AsyncResult<Long>> handler) {
  ...
  @Override
  public RedisCluster zadd(String key, double score, String member,
      Handler<AsyncResult<Long>> handler) {
  ...
  @Override
  public RedisCluster zaddMany(String key, Map<String, Double> members,
      Handler<AsyncResult<Long>> handler) {
  ...
  @Override
  public RedisCluster zcount(String key, double min, double max,
      Handler<AsyncResult<Long>> handler) {
  ...
  @Override
  public RedisCluster zincrby(String key, double increment, String member,
      Handler<AsyncResult<String>> handler) {
  ...
  @Override
  public RedisCluster zlexcount(String key, String min, String max,
      Handler<AsyncResult<Long>> handler) {
  ...
  @Override
  public RedisCluster zrange(String key, long start, long stop,
      Handler<AsyncResult<JsonArray>> handler) {
  ...
  public RedisCluster zrangeWithOptions(String key, long start, long stop, RangeOptions options,
      Handler<AsyncResult<JsonArray>> handler) {
    sendJsonArray(ZRANGE,
        toPayload(key, start, stop, options != null ? options.toJsonArray() : null),
        RedisClusterCRC16.getSlot(key), handler);
    return this;
  }
  ...
  public RedisCluster zrangebylex(String key, String min, String max, LimitOptions options,
      Handler<AsyncResult<JsonArray>> handler) {
    sendJsonArray(ZRANGEBYLEX,
        toPayload(key, min, max, options != null ? options.toJsonArray() : null),
        RedisClusterCRC16.getSlot(key), handler);
    return this;
  }
  ...
  @Override
  public RedisCluster zremMany(String key, List<String> members,
      Handler<AsyncResult<Long>> handler) {
  ...
  @Override
  public RedisCluster zremrangebylex(String key, String min, String max,
      Handler<AsyncResult<Long>> handler) {
  ...
  @Override
  public RedisCluster zremrangebyrank(String key, long start, long stop,
      Handler<AsyncResult<Long>> handler) {
  ...
  @Override
  public RedisCluster zremrangebyscore(String key, String min, String max,
      Handler<AsyncResult<Long>> handler) {
  ...
  public RedisCluster zrevrangebylex(String key, String max, String min, LimitOptions options,
      Handler<AsyncResult<JsonArray>> handler) {
    sendJsonArray(ZREVRANGEBYLEX,
        toPayload(key, max, min, options != null ? options.toJsonArray() : null),
        RedisClusterCRC16.getSlot(key), handler);
    return this;
  }

  @Override
  public RedisCluster zrevrangebyscore(String key, String max, String min,
      RangeLimitOptions options, Handler<AsyncResult<JsonArray>> handler) {
    sendJsonArray(ZREVRANGEBYSCORE,
        toPayload(key, max, min, options != null ? options.toJsonArray() : null),
        RedisClusterCRC16.getSlot(key), handler);
    return this;
  }
