...
public class MoveAmazonSQSBufferedAsyncClient implements AmazonSQSAsync {
    ...
    public static final String USER_AGENT = MoveAmazonSQSBufferedAsyncClient.class.getSimpleName() + "/"
...
//        return toReturn;
    ...
    public synchronized QueueBuffer putQBuffer(String qUrl, QueueBufferConfig config, ExecutorService executorService) {
        QueueBuffer toReturn = buffers.get(qUrl);
        if (toReturn != null) {
            return toReturn;
        }
