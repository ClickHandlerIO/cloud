...
public class SESPrepQueueHandler  implements QueueHandler<String>, Tables {
    ...
    public static final Logger LOG = LoggerFactory.getLogger(SESPrepQueueHandler.class);
...
//        List<EmailAttachmentEntity> attachmentEntities = db.select(EMAILA.fields())
