 ...
 */
public final class ActionName implements CharSequence, Comparable<CharSequence> {
    public static final ActionName EMPTY_STRING = cached("");
     ...
     */
    public ActionName(byte[] value, boolean copy) {
     ...
     * will be shared.
     */
    public ActionName(byte[] value, int start, int length, boolean copy) {
        if (copy) {
     ...
     */
    public ActionName(ByteBuffer value) {
        this(value, true);
    }
     ...
     */
    public ActionName(ByteBuffer value, boolean copy) {
        this(value, value.position(), value.remaining(), copy);
    }

    /**
     * Initialize an {@link ActionName} based upon the underlying storage from {@code value}.
     * There is a potential to share the underlying array storage if {@link ByteBuffer#hasArray()} is {@code true}.
     * if {@code copy} is {@code true} a copy will be made of the memory.
     * if {@code copy} is {@code false} the underlying storage will be shared, if possible.
     */
    public ActionName(ByteBuffer value, int start, int length, boolean copy) {
     ...
     */
    public ActionName(char[] value, int start, int length) {
        if (isOutOfBounds(start, length, value.length)) {
            throw new IndexOutOfBoundsException("expected: " + "0 <= start(" + start + ") <= start + length(" + length
     ...
     */
    public ActionName(char[] value, Charset charset) {
     ...
     * The copy will start at index {@code start} and copy {@code length} bytes.
     */
    public ActionName(char[] value, Charset charset, int start, int length) {
     ...
     * Create a copy of {@code value} into this instance assuming ASCII encoding.
     */
    public ActionName(CharSequence value) {
        this(value, 0, value.length());
    }
     ...
     * The copy will start at index {@code start} and copy {@code length} bytes.
     */
    public ActionName(CharSequence value, int start, int length) {
        if (isOutOfBounds(start, length, value.length())) {
            throw new IndexOutOfBoundsException("expected: " + "0 <= start(" + start + ") <= start + length(" + length
                            + ") <= " + "value.length(" + value.length() + ')');
        }
     ...
     * Create a copy of {@code value} into this instance using the encoding type of {@code charset}.
     */
    public ActionName(CharSequence value, Charset charset) {
        this(value, charset, 0, value.length());
    }
     ...
     * The copy will start at index {@code start} and copy {@code length} bytes.
     */
    public ActionName(CharSequence value, Charset charset, int start, int length) {
    ...
    /**
     * During normal use cases the {@link ActionName} should be immutable, but if the underlying array is shared,
     ...
     */
    public ActionName concat(CharSequence string) {
        int thisLen = length();
        ...
        if (string.getClass() == ActionName.class) {
            ActionName that = (ActionName) string;
            if (isEmpty()) {
                return that;
            }
            ...
            return new ActionName(newValue, false);
        }

        if (isEmpty()) {
            return new ActionName(string);
        }
    ...
    public boolean contentEqualsIgnoreCase(CharSequence string) {
        ...
        if (string.getClass() == ActionName.class) {
            ActionName rhs = (ActionName) string;
     ...
     */
    public ActionName subSequence(int start) {
     ...
     */
    @Override
    public ActionName subSequence(int start, int end) {
     ...
     * @throws IndexOutOfBoundsException if {@code start < 0} or {@code start > length()}.
     */
    public ActionName subSequence(int start, int end, boolean copy) {
        ...
        return new ActionName(value, start + offset, end - start, copy);
    }
     ...
     */
    public ActionName replace(char oldChar, char newChar) {
        ...
        return new ActionName(buffer, false);
    }
    ...
    public ActionName trim() {
        ...
        return new ActionName(value, start, end - start + 1, false);
    }
    ...
    public boolean contentEquals(CharSequence a) {
        ...
        if (a.getClass() == ActionName.class) {
            return equals(a);
        }
     ...
     */
    public ActionName[] split(String expr, int max) {
     ...
     */
    public ActionName[] split(char delim) {
        final List<ActionName> res = InternalThreadLocalMap.get().arrayList();
        ...
        for (int i = start; i < length; i++) {
            if (charAt(i) == delim) {
                if (start == i) {
                    ...
                    res.add(new ActionName(value, start + arrayOffset(), i - start, false));
                }
                start = i + 1;
            }
        }
        ...
        if (start == 0) { // If no delimiter was found in the value
            ...
            if (start != length) {
                ...
                res.add(new ActionName(value, start + arrayOffset(), length - start, false));
            } else {
        ...
        return res.toArray(new ActionName[res.size()]);
    }
    ...
    public int hashCode() {
        int h = hash;
        if (h == -1) {
            h = CRC16.calc(value, offset, length);
        }
        return h;
    }
    ...
    public boolean equals(Object obj) {
        if (obj == null || obj.getClass() != ActionName.class) {
            return false;
        }
        if (this == obj) {
            return true;
        ...
        ActionName other = (ActionName) obj;
    ...
    public static final HashingStrategy<CharSequence> CASE_INSENSITIVE_HASHER =
        ...
        public int hashCode(CharSequence o) {
            return ActionName.hashCode(o);
        }

        @Override
        public boolean equals(CharSequence a, CharSequence b) {
            return ActionName.contentEqualsIgnoreCase(a, b);
        }
    };
    ...
    public static final HashingStrategy<CharSequence> CASE_SENSITIVE_HASHER =
        ...
        @Override
        public boolean equals(CharSequence a, CharSequence b) {
            return ActionName.contentEquals(a, b);
        }
    };

    /**
     * Returns an {@link ActionName} containing the given character sequence. If the given string is already a
     * {@link ActionName}, just returns the same instance.
     */
    public static ActionName of(CharSequence string) {
        return string.getClass() == ActionName.class ? (ActionName) string : new ActionName(string);
    }

    /**
     * Returns an {@link ActionName} containing the given string and retains/caches the input
     ...
     */
    public static ActionName cached(String string) {
        ActionName asciiString = new ActionName(string);
     ...
     * algorithm with {@link #hashCode()} so that you can put both {@link ActionName}s and arbitrary
    ...
    public static int hashCode(CharSequence value) {
        ...
        if (value.getClass() == ActionName.class) {
    ...
    public static boolean contentEqualsIgnoreCase(CharSequence a, CharSequence b) {
        ...
        if (a.getClass() == ActionName.class) {
            return ((ActionName) a).contentEqualsIgnoreCase(b);
        }
        if (b.getClass() == ActionName.class) {
            return ((ActionName) b).contentEqualsIgnoreCase(a);
        }
    ...
    public static boolean contentEquals(CharSequence a, CharSequence b) {
        ...
        if (a.getClass() == ActionName.class) {
            return ((ActionName) a).contentEquals(b);
        }

        if (b.getClass() == ActionName.class) {
            return ((ActionName) b).contentEquals(a);
        }
    ...
    private static ActionName[] toAsciiStringArray(String[] jdkResult) {
        ActionName[] res = new ActionName[jdkResult.length];
        for (int i = 0; i < jdkResult.length; i++) {
            res[i] = new ActionName(jdkResult[i]);
        }
        return res;
    }
    ...
    public static boolean regionMatches(final CharSequence cs, final boolean ignoreCase, final int csStart,
        ...
        if (cs instanceof ActionName) {
            return ((ActionName) cs).regionMatches(ignoreCase, csStart, string, start, length);
        }
    ...
    public static int indexOf(final CharSequence cs, final char searchChar, int start) {
        ...
        } else if (cs instanceof ActionName) {
            return ((ActionName) cs).indexOf(searchChar, start);
        }
        if (cs == null) {
            return INDEX_NOT_FOUND;
        }
