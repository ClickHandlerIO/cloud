 ...
 */
public final class ActorID implements CharSequence, Comparable<CharSequence> {
    public static final ActorID EMPTY_STRING = cached("");
     ...
     */
    public ActorID(byte[] value, boolean copy) {
     ...
     * will be shared.
     */
    public ActorID(byte[] value, int start, int length, boolean copy) {
        if (copy) {
     ...
     */
    public ActorID(ByteBuffer value) {
        this(value, true);
    }
     ...
     */
    public ActorID(ByteBuffer value, boolean copy) {
        this(value, value.position(), value.remaining(), copy);
    }

    /**
     * Initialize an {@link ActorID} based upon the underlying storage from {@code value}.
     * There is a potential to share the underlying array storage if {@link ByteBuffer#hasArray()} is {@code true}.
     * if {@code copy} is {@code true} a copy will be made of the memory.
     * if {@code copy} is {@code false} the underlying storage will be shared, if possible.
     */
    public ActorID(ByteBuffer value, int start, int length, boolean copy) {
     ...
     */
    public ActorID(char[] value, int start, int length) {
        if (isOutOfBounds(start, length, value.length)) {
            throw new IndexOutOfBoundsException("expected: " + "0 <= start(" + start + ") <= start + length(" + length
     ...
     */
    public ActorID(char[] value, Charset charset) {
     ...
     * The copy will start at index {@code start} and copy {@code length} bytes.
     */
    public ActorID(char[] value, Charset charset, int start, int length) {
     ...
     * Create a copy of {@code value} into this instance assuming ASCII encoding.
     */
    public ActorID(CharSequence value) {
        this(value, 0, value.length());
    }
     ...
     * The copy will start at index {@code start} and copy {@code length} bytes.
     */
    public ActorID(CharSequence value, int start, int length) {
        if (isOutOfBounds(start, length, value.length())) {
            throw new IndexOutOfBoundsException("expected: " + "0 <= start(" + start + ") <= start + length(" + length
                            + ") <= " + "value.length(" + value.length() + ')');
        }
     ...
     * Create a copy of {@code value} into this instance using the encoding type of {@code charset}.
     */
    public ActorID(CharSequence value, Charset charset) {
        this(value, charset, 0, value.length());
    }
     ...
     * The copy will start at index {@code start} and copy {@code length} bytes.
     */
    public ActorID(CharSequence value, Charset charset, int start, int length) {
    ...
    /**
     * During normal use cases the {@link ActorID} should be immutable, but if the underlying array is shared,
     ...
     */
    public ActorID concat(CharSequence string) {
        int thisLen = length();
        ...
        if (string.getClass() == ActorID.class) {
            ActorID that = (ActorID) string;
            if (isEmpty()) {
                return that;
            }
            ...
            return new ActorID(newValue, false);
        }

        if (isEmpty()) {
            return new ActorID(string);
        }
     ...
     */
    public ActorID subSequence(int start) {
     ...
     */
    @Override
    public ActorID subSequence(int start, int end) {
     ...
     * @throws IndexOutOfBoundsException if {@code start < 0} or {@code start > length()}.
     */
    public ActorID subSequence(int start, int end, boolean copy) {
        ...
        return new ActorID(value, start + offset, end - start, copy);
    }
     ...
     */
    public ActorID replace(char oldChar, char newChar) {
        ...
        return new ActorID(buffer, false);
    }
    ...
    public ActorID trim() {
        ...
        return new ActorID(value, start, end - start + 1, false);
    }
     ...
     */
    public ActorID[] split(String expr, int max) {
     ...
     */
    public ActorID[] split(char delim) {
        final List<ActorID> res = InternalThreadLocalMap.get().arrayList();
        ...
        for (int i = start; i < length; i++) {
            if (charAt(i) == delim) {
                if (start == i) {
                    ...
                    res.add(new ActorID(value, start + arrayOffset(), i - start, false));
                }
                start = i + 1;
            }
        }
        ...
        if (start == 0) { // If no delimiter was found in the value
            ...
            if (start != length) {
                ...
                res.add(new ActorID(value, start + arrayOffset(), length - start, false));
            } else {
        ...
        return res.toArray(new ActorID[res.size()]);
    }
    ...
    public boolean equals(Object obj) {
        if (obj == null || obj.getClass() != ActorID.class) {
            return false;
        }
        if (this == obj) {
            return true;
    ...
    public static final HashingStrategy<CharSequence> CASE_INSENSITIVE_HASHER =
        ...
        public int hashCode(CharSequence o) {
            return ActorID.hashCode(o);
        }

        @Override
        public boolean equals(CharSequence a, CharSequence b) {
            return ActorID.contentEqualsIgnoreCase(a, b);
        }
    };
    ...
    public static final HashingStrategy<CharSequence> CASE_SENSITIVE_HASHER =
        ...
        @Override
        public boolean equals(CharSequence a, CharSequence b) {
            return ActorID.contentEquals(a, b);
        }
    };

    /**
     * Returns an {@link ActorID} containing the given character sequence. If the given string is already a
     * {@link ActorID}, just returns the same instance.
     */
    public static ActorID of(CharSequence string) {
        return string.getClass() == ActorID.class ? (ActorID) string : new ActorID(string);
    }

    /**
     * Returns an {@link ActorID} containing the given string and retains/caches the input
     ...
     */
    public static ActorID cached(String string) {
        ActorID asciiString = new ActorID(string);
     ...
     * algorithm with {@link #hashCode()} so that you can put both {@link ActorID}s and arbitrary
    ...
    public static int hashCode(CharSequence value) {
        ...
        if (value.getClass() == ActorID.class) {
    ...
    public static boolean contentEqualsIgnoreCase(CharSequence a, CharSequence b) {
        ...
        if (a.getClass() == ActorID.class) {
            return ((ActorID) a).contentEqualsIgnoreCase(b);
        }
        if (b.getClass() == ActorID.class) {
            return ((ActorID) b).contentEqualsIgnoreCase(a);
        }
    ...
    public static boolean contentEquals(CharSequence a, CharSequence b) {
        ...
        if (a.getClass() == ActorID.class) {
            return ((ActorID) a).contentEquals(b);
        }

        if (b.getClass() == ActorID.class) {
            return ((ActorID) b).contentEquals(a);
        }
    ...
    private static ActorID[] toAsciiStringArray(String[] jdkResult) {
        ActorID[] res = new ActorID[jdkResult.length];
        for (int i = 0; i < jdkResult.length; i++) {
            res[i] = new ActorID(jdkResult[i]);
        }
        return res;
    }
    ...
    public static boolean regionMatches(final CharSequence cs, final boolean ignoreCase, final int csStart,
        ...
        if (cs instanceof ActorID) {
            return ((ActorID) cs).regionMatches(ignoreCase, csStart, string, start, length);
        }
    ...
    public static int indexOf(final CharSequence cs, final char searchChar, int start) {
        ...
        } else if (cs instanceof ActorID) {
            return ((ActorID) cs).indexOf(searchChar, start);
        }
        if (cs == null) {
            return INDEX_NOT_FOUND;
        }
