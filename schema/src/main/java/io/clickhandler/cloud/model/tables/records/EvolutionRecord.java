...
public class EvolutionRecord extends UpdatableRecordImpl<EvolutionRecord> implements Record6<String, Long, Timestamp, Boolean, Timestamp, Timestamp> {

	private static final long serialVersionUID = -1507379823;
	...
	/**
	 * Setter for <code>evolution.started</code>.
	 */
	public EvolutionRecord setStarted(Timestamp value) {
		setValue(4, value);
		return this;
	}

	/**
	 * Getter for <code>evolution.started</code>.
	 */
	 ...
	 */
	@Override
	public Row6<String, Long, Timestamp, Boolean, Timestamp, Timestamp> fieldsRow() {
	 ...
	 */
	@Override
	public Row6<String, Long, Timestamp, Boolean, Timestamp, Timestamp> valuesRow() {
	...
	public Field<Timestamp> field5() {
		return Evolution.EVOLUTION.STARTED;
	}
	 ...
	 */
	@Override
	public EvolutionRecord value6(Timestamp value) {
		setEnd(value);
		return this;
	}
	 ...
	 */
	@Override
	public EvolutionRecord values(String value1, Long value2, Timestamp value3, Boolean value4, Timestamp value5, Timestamp value6) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public EvolutionRecord(String id, Long v, Timestamp c, Boolean success, Timestamp started, Timestamp end) {
		super(Evolution.EVOLUTION);
