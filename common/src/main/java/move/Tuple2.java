...
public final class Tuple2<T1, T2> implements Tuple, Comparable<Tuple2<T1, T2>>, Serializable {
   ...
   *
   * @return A new Tuple where the first element is the second element of this Tuple and the second
   * element is the first element of this Tuple.
   */
   ...
   */
  public <U1, U2> Tuple2<U1, U2> map(Function<? super T1, ? extends U1> f1,
