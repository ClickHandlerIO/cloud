...
public final class Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9> implements Tuple,
    Comparable<Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9>>, Serializable {
  ...
  public static <T1, T2, T3, T4, T5, T6, T7, T8, T9> Comparator<Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9>> comparator(
      ...
      Comparator<? super T4> t4Comp, Comparator<? super T5> t5Comp, Comparator<? super T6> t6Comp,
      Comparator<? super T7> t7Comp, Comparator<? super T8> t8Comp, Comparator<? super T9> t9Comp) {
    return (Comparator<Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9>> & Serializable) (t1, t2) -> {
      ...
      final int check9 = t9Comp.compare(t1._9, t2._9);
      if (check9 != 0) {
        return check9;
      }
  ...
  private static <U1 extends Comparable<? super U1>, U2 extends Comparable<? super U2>, U3 extends Comparable<? super U3>, U4 extends Comparable<? super U4>, U5 extends Comparable<? super U5>, U6 extends Comparable<? super U6>, U7 extends Comparable<? super U7>, U8 extends Comparable<? super U8>, U9 extends Comparable<? super U9>> int compareTo(
    ...
    final int check9 = t1._9.compareTo(t2._9);
    if (check9 != 0) {
      return check9;
    }
  ...
  @Override
  public int compareTo(Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, T9> that) {
    return Tuple9.compareTo(this, that);
  }
  ...
  /**
   * Sets the 9th element of this tuple to the given {@code value}.
   *
   * @param value the new value
  ...
  public <U1, U2, U3, U4, U5, U6, U7, U8, U9> Tuple9<U1, U2, U3, U4, U5, U6, U7, U8, U9> map(
      ...
      Function<? super T5, ? extends U5> f5, Function<? super T6, ? extends U6> f6,
      Function<? super T7, ? extends U7> f7, Function<? super T8, ? extends U8> f8,
    ...
    return Tuple
        .of(f1.apply(_1), f2.apply(_2), f3.apply(_3), f4.apply(_4), f5.apply(_5), f6.apply(_6),
            f7.apply(_7), f8.apply(_8), f9.apply(_9));
  }
   ...
   */
  public <U> Tuple9<U, T2, T3, T4, T5, T6, T7, T8, T9> map1(
      Function<? super T1, ? extends U> mapper) {
    Objects.requireNonNull(mapper, "mapper is null");
    final U u = mapper.apply(_1);
    return Tuple.of(u, _2, _3, _4, _5, _6, _7, _8, _9);
  }
   ...
   */
  public <U> Tuple9<T1, U, T3, T4, T5, T6, T7, T8, T9> map2(
      Function<? super T2, ? extends U> mapper) {
    Objects.requireNonNull(mapper, "mapper is null");
    final U u = mapper.apply(_2);
    return Tuple.of(_1, u, _3, _4, _5, _6, _7, _8, _9);
  }
   ...
   */
  public <U> Tuple9<T1, T2, U, T4, T5, T6, T7, T8, T9> map3(
      Function<? super T3, ? extends U> mapper) {
    Objects.requireNonNull(mapper, "mapper is null");
    final U u = mapper.apply(_3);
    return Tuple.of(_1, _2, u, _4, _5, _6, _7, _8, _9);
  }
   ...
   */
  public <U> Tuple9<T1, T2, T3, U, T5, T6, T7, T8, T9> map4(
      Function<? super T4, ? extends U> mapper) {
    Objects.requireNonNull(mapper, "mapper is null");
    final U u = mapper.apply(_4);
    return Tuple.of(_1, _2, _3, u, _5, _6, _7, _8, _9);
  }
   ...
   */
  public <U> Tuple9<T1, T2, T3, T4, U, T6, T7, T8, T9> map5(
      Function<? super T5, ? extends U> mapper) {
    Objects.requireNonNull(mapper, "mapper is null");
    final U u = mapper.apply(_5);
    return Tuple.of(_1, _2, _3, _4, u, _6, _7, _8, _9);
  }
   ...
   */
  public <U> Tuple9<T1, T2, T3, T4, T5, U, T7, T8, T9> map6(
      Function<? super T6, ? extends U> mapper) {
    Objects.requireNonNull(mapper, "mapper is null");
    final U u = mapper.apply(_6);
    return Tuple.of(_1, _2, _3, _4, _5, u, _7, _8, _9);
  }
   ...
   */
  public <U> Tuple9<T1, T2, T3, T4, T5, T6, U, T8, T9> map7(
      Function<? super T7, ? extends U> mapper) {
    Objects.requireNonNull(mapper, "mapper is null");
    final U u = mapper.apply(_7);
    return Tuple.of(_1, _2, _3, _4, _5, _6, u, _8, _9);
  }
   ...
   */
  public <U> Tuple9<T1, T2, T3, T4, T5, T6, T7, U, T9> map8(
      Function<? super T8, ? extends U> mapper) {
    Objects.requireNonNull(mapper, "mapper is null");
    final U u = mapper.apply(_8);
    return Tuple.of(_1, _2, _3, _4, _5, _6, _7, u, _9);
  }

  /**
   * Maps the 9th component of this tuple to a new value.
   *
   * @param <U> new type of the98th component
   * @param mapper A mapping function
   * @return a new tuple based on this tuple and substituted 8th component
   */
  public <U> Tuple9<T1, T2, T3, T4, T5, T6, T7, T8, U> map9(
      Function<? super T8, ? extends U> mapper) {
    Objects.requireNonNull(mapper, "mapper is null");
    final U u = mapper.apply(_8);
    return Tuple.of(_1, _2, _3, _4, _5, _6, _7, _8, u);
  }
  // -- Object
