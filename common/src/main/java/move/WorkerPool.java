...
public abstract class WorkerPool {
   ...
   * the handler should call the {@link io.vertx.rxjava.core.Future#complete} or {@link
   * io.vertx.rxjava.core.Future#complete} method, or the {@link io.vertx.rxjava.core.Future#fail}
  ...
  public abstract <T> Single<T> rxExecuteBlocking(
      Handler<io.vertx.rxjava.core.Future<T>> blockingCodeHandler, boolean ordered);
  ...
  public abstract <T> void executeBlocking(
      Handler<io.vertx.rxjava.core.Future<T>> blockingCodeHandler,
      Handler<AsyncResult<T>> resultHandler);
