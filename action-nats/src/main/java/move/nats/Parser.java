...
import static move.nats.Parser.NatsOp.INFO_ARG;
import static move.nats.Parser.NatsOp.MINUS_ERR_ARG;
import static move.nats.Parser.NatsOp.MSG_ARG;
import static move.nats.Parser.NatsOp.MSG_END;
import static move.nats.Parser.NatsOp.MSG_PAYLOAD;
import static move.nats.Parser.NatsOp.OP_I;
import static move.nats.Parser.NatsOp.OP_IN;
import static move.nats.Parser.NatsOp.OP_INF;
import static move.nats.Parser.NatsOp.OP_INFO;
import static move.nats.Parser.NatsOp.OP_INFO_SPC;
import static move.nats.Parser.NatsOp.OP_M;
import static move.nats.Parser.NatsOp.OP_MINUS;
import static move.nats.Parser.NatsOp.OP_MINUS_E;
import static move.nats.Parser.NatsOp.OP_MINUS_ER;
import static move.nats.Parser.NatsOp.OP_MINUS_ERR;
import static move.nats.Parser.NatsOp.OP_MINUS_ERR_SPC;
import static move.nats.Parser.NatsOp.OP_MS;
import static move.nats.Parser.NatsOp.OP_MSG;
import static move.nats.Parser.NatsOp.OP_MSG_SPC;
import static move.nats.Parser.NatsOp.OP_P;
import static move.nats.Parser.NatsOp.OP_PI;
import static move.nats.Parser.NatsOp.OP_PIN;
import static move.nats.Parser.NatsOp.OP_PING;
import static move.nats.Parser.NatsOp.OP_PLUS;
import static move.nats.Parser.NatsOp.OP_PLUS_O;
import static move.nats.Parser.NatsOp.OP_PLUS_OK;
import static move.nats.Parser.NatsOp.OP_PO;
import static move.nats.Parser.NatsOp.OP_PON;
import static move.nats.Parser.NatsOp.OP_PONG;
import static move.nats.Parser.NatsOp.OP_START;
...
public class Parser {
  ...
  void parse(ByteBuf buf) throws ParseException, InterruptedException {
//    if (ps.state == MSG_PAYLOAD) {
//      boolean done = false;
//      if (ps.msgBuf != null) {
...
//    }
  ...
  static class ParseState {
    ...
    final byte[] argBufStore = new byte[DEFAULT_BUF_SIZE];
    ...
    byte[] msgBufStore = new byte[DEFAULT_BUF_SIZE];
