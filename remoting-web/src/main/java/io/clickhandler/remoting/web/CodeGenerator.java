...
import io.clickhandler.reactGwt.client.remoting.PushSubscription;
import io.clickhandler.reactGwt.client.remoting.ResponseEvent;
import io.clickhandler.reactGwt.client.remoting.WsAction;
import io.clickhandler.reactGwt.client.remoting.WsDispatcher;
...
public class CodeGenerator {
    ...
    public void generate() {
        ...
        final String gwtModuleFileContents = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
            ...
            "    <inherits name=\"io.clickhandler.ReactGwt\" />\n" +
            "\n" +
            "    <source path=\"\"/>\n" +
            "</module>\n";
        try {
