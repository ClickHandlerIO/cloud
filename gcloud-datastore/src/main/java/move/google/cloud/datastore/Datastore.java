...
public interface Datastore extends Closeable {
   ...
   * @return the result of the transaction request.
   */
  Single<TransactionResult> transactionAsync();
   ...
   * @return the result of the rollback request.
   */
  Single<RollbackResult> rollbackAsync(final Single<TransactionResult> txn);
   ...
   * @return the result of the commit request.
   */
  Single<MutationResult> commitAsync(final Single<TransactionResult> txn);
   ...
   * @return the result of the allocate ids request.
   */
  Single<AllocateIdsResult> executeAsync(final AllocateIds statement);
   ...
   * @return the result of the query request.
   */
  Single<QueryResult> executeAsync(final KeyQuery statement);
   ...
   * @return the result of the query request.
   */
  Single<QueryResult> executeAsync(final List<KeyQuery> statements);
   ...
   * @return the result of the query request.
   */
  Single<QueryResult> executeAsync(final KeyQuery statement, final Single<TransactionResult> txn);
   ...
   * @return the result of the query request.
   */
  Single<QueryResult> executeAsync(final List<KeyQuery> statements, final Single<TransactionResult> txn);
   ...
   * @return the result of the mutation request.
   */
  Single<MutationResult> executeAsync(final MutationStatement statement);
   ...
   * @return the result of the mutation request.
   */
  Single<MutationResult> executeAsync(final MutationStatement statement, final Single<TransactionResult> txn);
   ...
   * @return the result of the mutation request.
   */
  Single<MutationResult> executeAsync(final Batch batch);
   ...
   * @return the result of the mutation request.
   */
  Single<MutationResult> executeAsync(final Batch batch, final Single<TransactionResult> txn);
   ...
   * @return the result of the query request.
   */
  Single<QueryResult> executeAsync(final Query statement);
   ...
   * @return the result of the query request.
   */
  Single<QueryResult> executeAsync(final Query statement, final Single<TransactionResult> txn);
}
