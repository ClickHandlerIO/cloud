...
interface ModifyAckDeadlineRequest {
  ...
  class Builder implements ModifyAckDeadlineRequest {
    ...
    public Builder ackIds(final List<String> ackIds) {
      this.ackIds = ackIds;
      return this;
    }

    public Builder ackDeadlineSeconds(final int ackDeadlineSeconds) {
