...
public class PubsubFuture<T> extends CompletableFuture<T> {
  ...
  @Override
  public PubsubFuture<Void> runAfterBothAsync(final CompletionStage<?> other,
  ...
  @Override
  public PubsubFuture<Void> runAfterEitherAsync(final CompletionStage<?> other,
      final Runnable action) {
