...
/**
 * Thread safe backoff. Assumes threads that use the same backoff instance all share the same rate
 * limit, and throttles best effort until reset isn't called
 */
