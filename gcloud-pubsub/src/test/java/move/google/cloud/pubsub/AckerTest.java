...
public class AckerTest {
  ...
  @Test
  public void testLatencyBoundedBatchingSingleMessage()
  ...
  @Test
  public void testLatencyBoundedBatchingTwoMessages()
      throws InterruptedException, ExecutionException {
    // Ack two messages
    acker.acknowledge("m1");
  ...
  private void setUpPubsubClient() {
    ...
    when(pubsub.acknowledge(anyString(), anyString(), anyListOf(String.class)))
        .thenAnswer(invocation -> {
          ...
          final String canonicalSubscription = Subscription
              .canonicalSubscription(project, subscription);
