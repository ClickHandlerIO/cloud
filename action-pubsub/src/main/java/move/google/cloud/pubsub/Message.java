...
public interface Message {
  ...
  class MessageBuilder implements Message {
    ...
    public MessageBuilder data(final String data) {
      this.data = data;
      return this;
    }

    public MessageBuilder attributes(
        final Map<String, String> attributes) {
      this.attributes = attributes;
      return this;
    }

    public MessageBuilder attributes(String name, String value) {
      if (attributes == null) {
    ...
    public MessageBuilder putAttribute(String name, String value) {
      if (attributes == null) {
        attributes = new LinkedHashMap<>();
      }
      attributes.put(name, value);
    ...
    public MessageBuilder messageId(final Optional<String> messageId) {
      this.messageId = messageId;
      return this;
    }

    public MessageBuilder publishTime(final Optional<Instant> publishTime) {
