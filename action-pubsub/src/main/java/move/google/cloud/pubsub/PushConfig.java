...
public interface PushConfig {
  ...
  class PushConfigBuilder implements PushConfig {
    ...
    public PushConfigBuilder pushEndpoint(final String pushEndpoint) {
      this.pushEndpoint = Optional.ofNullable(pushEndpoint);
      return this;
    }

    public PushConfigBuilder pushEndpoint(final Optional<String> pushEndpoint) {
