...
class ConfigurableSSLSocketFactory extends SSLSocketFactory {
  ...
  ConfigurableSSLSocketFactory(final String[] enabledCipherSuites,
  ...
  @Override
  public Socket createSocket(final Socket sock, final String host, final int port,
  ...
  public Socket createSocket(final String host, final int port, final InetAddress localAddress,
      final int localPort)
      throws IOException {
    final SSLSocket s = (SSLSocket) sslSocketFactory
