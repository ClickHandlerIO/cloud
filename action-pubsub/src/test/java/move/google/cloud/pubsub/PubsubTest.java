...
import move.google.cloud.pubsub.PublishResponse;
...
import move.google.cloud.pubsub.RequestFailedException;
...
public class PubsubTest {
  ...
  public void testListSubscriptions() throws Exception {
    ...
    final SubscriptionList response = SubscriptionList.of(
        Subscription.of(PROJECT, SUBSCRIPTION_1, TOPIC_1),
