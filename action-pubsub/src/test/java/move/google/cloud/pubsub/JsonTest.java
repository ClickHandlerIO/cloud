...
import move.google.cloud.pubsub.Json;
...
public class JsonTest {
  ...
  public void testReadGuava() throws Exception {
    ...
    final ImmutableMap<?, ?> value = Json
        .read("{\"foo\":\"bar\"}".getBytes("UTF-8"), ImmutableMap.class);
  ...
  public void testReadPresentOptional() throws Exception {
    ...
    final ValueWithOptional value = Json
        .read("{\"foo\":\"bar\"}".getBytes("UTF-8"), ValueWithOptional.class);
    assertThat(value, is(expected));
  }
  ...
  class ValueWithOptionalBuilder implements ValueWithOptional {

    Optional<String> foo;

    public ValueWithOptional build() {
      return this;
    }
    ...
    public ValueWithOptionalBuilder foo(final Optional<String> foo) {
      this.foo = foo;
      return this;
    }

    public ValueWithOptionalBuilder foo(final String foo) {
