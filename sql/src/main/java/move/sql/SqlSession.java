...
//        return connection;
   ...
   */
  @Deprecated
  protected <R extends Record> R record(Class<R> recordClass) {
    if (recordClass == null) {
      return null;
    }
   ...
   */
  @Deprecated
  protected <E extends AbstractEntity, R extends Record> R map(E entity) {
   ...
   */
  @Deprecated
  protected <E extends AbstractEntity, R extends Record> EntityMapper<E, R> mapper(Class cls) {
   ...
   */
  @Deprecated
  protected <E extends AbstractEntity, R extends Record> List<R> mapRecords(Collection<E> entities) {
   ...
   */
  @Deprecated
  protected <E extends AbstractEntity, R extends Record> List<R> mapRecords(EntityMapper<E, R> mapper,
   ...
   * @return
   */
  protected <R extends Record> R getRecord(Class<R> recordClass, String id) {
    return getRecord(db.getMapping(recordClass), id);
  }

  protected <R extends Record> R newRecord(Class<R> recordClass) {
  ...
  protected <R extends Record> R getRecord(TableMapping mapping, String id) {
   ...
   * @return
   */
  protected <R extends Record> List<R> getRecords(Class<R> recordClass, String... id) {
   ...
   * @return
   */
  protected <R extends Record> List<R> getRecords(Class<R> recordClass, Collection<String> ids) {
   ...
   * @return
   */
  protected <R extends Record> List<R> getRecords(TableMapping mapping, Collection<String> ids) {
   ...
   * @return
   */
  protected <R extends Record> List<R> getRecords(
   ...
   * @param <R>
   */
  protected <R extends Record> void fetch(TableMapping mapping, List<R> recordList,
      Collection<String> ids) {
    final List<R> result = (List<R>) create().selectFrom(mapping.TBL()).where(mapping.ID().in(ids))
        .fetch();
  ...
  protected <R extends Record> List<R> fetch(TableMapping mapping, Collection<String> ids) {
    return ensureNotNull((List<R>) create().selectFrom(mapping.TBL()).where(mapping.ID().in(ids)).fetch());
  }
   ...
   */
  @Nullable
  public <E extends AbstractEntity> E getEntity(Class<E> cls, String id) {
    return db.map((Record) getRecord(db.getCheckedMapping(cls), id));
  }
   ...
   */
  @Nullable
  public <E extends AbstractEntity> E get(Class<E> cls, String id) {
    return db.map((Record) getRecord(db.getCheckedMapping(cls), id));
  }
   ...
   */
  @Nullable
  public <E extends AbstractEntity> List<E> get(Class<E> entityClass, String... ids) {
   ...
   */
  @Nullable
  public <E extends AbstractEntity> List<E> getEntities(Class<E> entityClass, String... ids) {
    return getEntities(entityClass, Lists.newArrayList(ids));
  }
   ...
   */
  @NotNull
  public <E extends AbstractEntity, R extends Record> List<E> getEntities(Class<E> entityClass,
      Collection<String> ids) {
   ...
   */
  @NotNull
  public <E extends AbstractEntity, R extends Record> Map<String, E> getMap(
      Class<E> entityClass,
      Collection<String> ids) {
   ...
   */
  @NotNull
  public <E extends AbstractEntity, R extends Record> Map<String, E> getMap(Class<E> entityClass,
      Map<String, E> toMap, Collection<String> ids) {
    if (toMap == null) {
      toMap = new HashMap<>();
    }
   ...
   */
  @NotNull
  public <E extends AbstractEntity> Map<String, E> selectMap(Class<E> entityClass,
  ...
  public <T> List<T> select(final Class<T> cls, Condition condition) {
    return ensureNotNull(select(cls, condition, 1000));
  }
  ...
  public <T> List<T> select(final Class<T> cls, Condition condition, int limit) {
    ...
    return ensureNotNull(create().selectFrom(mapping.tbl).where(condition).limit(limit).fetchInto(cls));
  }
  ...
  public <T> List<T> select(final Class<T> cls, Collection<? extends Condition> conditions) {
    return ensureNotNull(select(cls, conditions, 1000));
  }
  ...
  public <T> List<T> select(final Class<T> cls, Collection<? extends Condition> conditions,
    ...
    return ensureNotNull(create().selectFrom(mapping.tbl).where(conditions).limit(limit).fetchInto(cls));
  }
  ...
  @NotNull
  public <T> List<T> select(final Class<T> cls, Collection<? extends Condition> conditions,
      int limit, int timeoutInSeconds) {
    final TableMapping mapping = db.getMapping(cls);
    if (mapping == null) {
      throw new RuntimeException("No mapping for class [" + cls.getCanonicalName() + "]");
    }
    return ensureNotNull(create().selectFrom(mapping.tbl).where(conditions).limit(limit)
        .queryTimeout(timeoutInSeconds).fetchInto(cls));
  }

  protected <T> List<T> ensureNotNull(List<T> list) {
    if (list == null) {
  ...
  public <E extends AbstractEntity> Query updateQuery(E entity, Condition condition) {
    ...
    if (entity.getId() == null || entity.getId().isEmpty()) {
      throw new RuntimeException("Entity [" + entity.getClass().getCanonicalName()
          + "] does not have it's 'id' set. Cannot update.");
    }
    ...
    try {
      ...
      if (last == null) {
        throw new RuntimeException(
            "Entity [" + entity.getClass().getCanonicalName() + "] has no fields to create.");
      }
   ...
   * @return
   */
  public <E extends AbstractEntity, R extends Record> SqlResult<Integer> update(final E entity,
   ...
   * @return
   */
  public <E extends AbstractEntity, R extends Record> SqlResult<Integer> updateAtomic(
      final E entity, Collection<? extends Field<?>> fields) {
    Preconditions.checkNotNull(entity, "entity must be specified");
    return SqlResult.atomic(updateQuery(entity).execute());
  }
   ...
   * @return
   */
  public <E extends AbstractEntity, R extends UpdatableRecord<R>> SqlResult<int[]> update(
   ...
   */
  public <E extends AbstractEntity, R extends UpdatableRecord<R>> SqlResult<int[]> update(
      final List<E> entities, int timeoutSeconds) {
   ...
   * @return
   */
  public <E extends AbstractEntity, R extends UpdatableRecord<R>> SqlResult<int[]> updateAtomic(
      final List<E> entities) {
   ...
   * @return
   */
  public <E extends AbstractEntity, R extends Record> SqlResult<Integer> deleteAtomic(
      final E object) {
    Preconditions.checkNotNull(object, "object must be specified");
   ...
   * @return
   */
  public <E extends AbstractEntity, R extends UpdatableRecord<R>> SqlResult<int[]> delete(
      final List<E> entities) {
   ...
   * @return
   */
  public <E extends AbstractEntity, R extends UpdatableRecord<R>> SqlResult<int[]> deleteAtomic(
      final List<E> entities) {
   ...
   * @return
   */
  public <T extends AbstractEntity> SqlResult<Integer> deleteAtomic(Class<T> entityClass,
      String id) {
    Preconditions.checkNotNull(entityClass, "entityClass was null");
  ...
  public SqlResult<int[]> save(List<? extends Query> queries, int timeoutSeconds, Logger logger) {
    ...
    if (result.isRollback()) {
      if (logger.isDebugEnabled()) {
        SqlUtils.failedQueries(queries, result.get())
            .forEach(s -> logger.debug("Failed to Commit: " + s));
      }
    }
    return result;
  }
   ...
   * @return
   */
  public SqlResult<int[]> saveAtomic(List<? extends Query> queries, int timeoutSeconds,
      Logger logger) {
