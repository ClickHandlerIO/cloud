...
public class DatabaseSession {
    ...
    DatabaseSession(final Database db,
     ...
     * @return
     */
    public <R extends UpdatableRecord<R>, E extends AbstractEntity> E getEntity(Class cls, String id) {
            ...
            if (autoGeneratedKeys.length != 0) {
                try {
                    ...
                    throw new PersistException("This JDBC driver does not support PreparedStatement.getGeneratedKeys()."
                            + " Please use setUpdateAutoGeneratedKeys(false) in your DatabaseSession instance"
...
//                    }
     ...
     * @return
     */
    public <E extends AbstractEntity> int store(E entity) {
     ...
     * @return
     */
    public <E extends AbstractEntity> int insert(E entity) {
        Preconditions.checkNotNull(entity, "entity must be specified");
        // Get mapper.
        final EntityMapper<E, UpdatableRecord> mapper = db.entityMapper(entity.getClass());
        // Map to Record.
     ...
     * @param <E>
     */
    public <E extends AbstractEntity> int[] insert(List<E> entities) {
        if (entities == null || entities.isEmpty()) {
            return new int[0];
        }
     ...
     * @return
     */
    public <E extends AbstractEntity> int update(final E entity) {
        Preconditions.checkNotNull(entity, "entity must be specified");
        // Get mapper.
        final EntityMapper<E, UpdatableRecord> mapper = db.entityMapper(entity.getClass());
        // Map to Record.
    ...
    public <E extends AbstractEntity, R extends UpdatableRecord<R>> int[] update(final List<E> entities) {
     ...
     * @return
     */
    public <E extends AbstractEntity, R extends UpdatableRecord<R>> int delete(final E object) {
    ...
    public <E extends AbstractEntity, R extends UpdatableRecord<R>> int[] delete(final List<E> entities) {
        Preconditions.checkNotNull(entities, "entities was null");
     ...
     * @return
     */
    public <T extends AbstractEntity> int delete(Class<T> entityClass, String id) {
