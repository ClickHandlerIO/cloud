 ...
 * @author Lukas Eder
 */
public class DefaultTransactionConnectionProvider implements ConnectionProvider {

    private static final JooqLogger log = JooqLogger.getLogger(DefaultTransactionConnectionProvider.class);
    Connection                      connection;
    final boolean                   finalize;

    public DefaultTransactionConnectionProvider(Connection connection) {
        this(connection, false);
    }

    DefaultTransactionConnectionProvider(Connection connection, boolean finalize) {
